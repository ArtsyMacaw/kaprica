...
{
    struct alphabetical_list *sorted = xmalloc(sizeof(struct alphabetical_list) * src->num_types);
    ...
    qsort(sorted, src->num_types, sizeof(struct alphabetical_list), alphabetical_sort);
